...
- [ ] **Per-rule pages: fill the remaining ~141/234 rules.** Shipped:
      ...
      (`RulesDocGeneratorTests`) byte-compares against `docs/`. 93/234 rules
      ...
      naming, session-date-setting, hint, window-frame, view-ordering) — a
      ...
      database-configuration, undersized-declaration, module-compile-flag,
