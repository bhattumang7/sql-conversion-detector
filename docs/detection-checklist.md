...
- [ ] **Per-rule pages: fill the remaining ~113/234 rules.** Shipped:
      ...
      (`RulesDocGeneratorTests`) byte-compares against `docs/`. 121/234 rules
      ...
      control-flow-risk, statement-shape) — a rule with no entry still
