...
- [ ] **Per-rule pages: fill the remaining ~147/234 rules.** Shipped:
      ...
      (`RulesDocGeneratorTests`) byte-compares against `docs/`. 87/234 rules
      ...
      naming, session-date-setting, hint, window-frame) — a rule with no
      ...
      undersized-declaration, view-ordering, module-compile-flag,
