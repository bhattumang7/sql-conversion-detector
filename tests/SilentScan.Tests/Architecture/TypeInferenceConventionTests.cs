...
public sealed partial class TypeInferenceConventionTests
{
    ...
    public void ScopedSqlVisitorBaseIsTheOnlySourceOfScopeAwareColumnResolution()
    {
        ...
        Assert.True(offenders.Count == 0,
            ...
            "ScopedSqlVisitorBase - this is the PredicateVisitorSupport-shaped duplication that Phase 1 " +
            "removed; scanners must inherit ScopedSqlVisitorBase rather than reintroducing a parallel " +
            "helper:\n" + string.Join('\n', offenders));
    }
}
