...
public sealed class ScanReportBuilderDynamicSqlReparseTests
{
    ...
    public void ThreeRoundOutputChain_EnumeratesSourceNoMoreThanASingleRoundWould()
    {
        ...
        // Reverting to re-enumerating per round pushes this fixture's 3 rounds well past that. 48
        // sits strictly between the two (measured 46 through the IndexCoverageScanner pass above;
        // +1 for the new TriggerCorrectnessScanner full-corpus pass and +1 for the new
