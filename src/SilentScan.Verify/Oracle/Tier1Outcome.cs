...
public enum Tier1Outcome
{
    ...
    /// <summary>The corpus's own DDL never indexed this column, and no scratch index could be deployed for it either (e.g. an unindexable column type) - there is no seek to have lost in the first place, so no plan was ever captured and nothing was confirmed.</summary>
